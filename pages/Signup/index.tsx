    ...
    <>
      ...
      <div className="flex justify-center align-center h-screen">
        <div className="m-auto p-7  flex flex-col items-center rounded-3xl lg:drop-shadow-2xl">
          <h1 className="font-serif text-xl pb-2 lg:text-5xl lg:pb-6">Create your account</h1>
          <p className="text-sm leading-6 text-examine-gray lg:text-xl lg:pb-6">It Includes a free 2 week trial!</p>
          ...
          <form action="">
            <div className="w-full grid gap-8">
              ...
              <div>
                <button className="text-center w-full bg-primary-color py-2 px-5 text-white rounded lg:py-3 lg:text-xl">Start your 2-weeks free trial!</button>
              </div>
